...
/**
 * Build the verifier freshness line from data_freshness. Prefers the engine-run
 ...
 * shows real freshness even with the headless engine / the external verifier verifier disabled.
 */
...
function renderBriefing(data) {
  ...
  // verifier freshness line — always present, on every brief. The visible daily proof
