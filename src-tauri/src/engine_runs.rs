...
//! were live, and the state an external verifier (the external verifier) re-checks: a refresh that exits 0
...
// ============================================================================
// Tests — the signing contract an external verifier (the external verifier) depends on
// ============================================================================
//
