...
pub mod sources;
mod speculative_embed;
pub(crate) mod stability_detector;
...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            taste_test_commands::get_calibration_sprint_items,
            taste_test_commands::record_calibration_sprint_response,
            taste_test_commands::get_calibration_sprint_status,
            ...
            settings_commands::snooze_items,
            ...
            blind_spots::get_cached_blind_spot_assessment,
