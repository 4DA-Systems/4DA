...
> drift back out of sync. Last synced: 2026-08-12.

> **Direction of truth changed.** This file used to be the source that generated the others.
> It is not any more — `CLAUDE.md` is. `scripts/sync-ai-rules.sh` was deleted 2026-08-12: it
> generated the tool configs *from this file* and **overwrote `CLAUDE.md`**, so running it
> would have clobbered the maintained instructions with whatever was here. Regeneration is
> manual until a generator that runs in the correct direction exists.

## What Is 4DA

**4DA reads the internet for developers — privately, locally — and gets sharper every day.**

4DA (4 Dimensional Autonomy) is the Tauri 2.0 desktop app that delivers on that promise. It learns
from how you engage with what it shows you: yesterday's noise becomes tomorrow's signal.
