---
title: "모듈 S: 수입원 쌓기 -- STREETS by 4DA"
description: "지난 13주 동안 대부분의 개발자가 절대 구축하지 못하는 것을 구축했습니다: 자율적인 수입 운영 체계입니다. 인프라가 있고, 수익 엔진이 가동 중이며, 실행 규율이 있고, 인텔리전스가 있고, 자동화가 있습니다. (해자 기반 전략을 완전히 활성화하려면 모듈 T — Techn..."
layout: streets-module.njk
permalink: "/streets/ko/stacking-streams/"
...
prevLabel: "이전"
nextLabel: "다음"
prevUrl: "/streets/ko/tactical-automation/"
prevTitle: "모듈 T: 전술적 자동화"
alternates:
...
이제부터가 매월 $2K를 추가로 버는 개발자와 급여를 완전히 대체하는 개발자를 구분하는 부분입니다: **쌓기(스태킹)**입니다.
...
> **흔한 실수:** 최대 상호작용이 아닌 최대 수익을 위해 수입원을 설계하는 것입니다. 월 $800을 생성하면서 다른 두 수입원을 공급하는 수입원이 고립되어 월 $2,000을 생성하는 수입원보다 더 가치 있습니다. 고립된 수입원은 $2,000을 더합니다. 연결된 수입원은 $800에 더해 전체 포트폴리오의 성장을 가속화합니다. 12개월 동안 보면, 연결된 수입원이 매번 이깁니다.
...
월 1만 dollars는 모든 것이 바뀌는 숫자입니다. 자의적이지 않습니다.

- **월 $10K = 연 $120K.** 이것은 미국 소프트웨어 개발자 중위 급여와 같거나 초과합니다.
- **월 $10K 세후(약 $7K)는 대부분의 미국 도시에서 중산층 생활을 유지할 수 있으며** 세계 거의 어디서든 편안한 생활을 할 수 있습니다.
- **복수 수입원에서의 월 $10K는 단일 고용주에서의 월 $15K보다 안정적입니다.** 어떤 단일 장애도 $10K에서 $0으로 만들 수 없기 때문입니다.
- **월 $10K는 모델을 증명합니다.** 독립적으로 월 $10K를 벌 수 있다면, 월 $20K도 벌 수 있습니다. 시스템이 작동합니다. 이후의 모든 것은 최적화입니다.

월 $10K 미만이면 보충하고 있는 것입니다. 월 $10K면 독립한 것입니다. 그래서 중요합니다.
...
**세금 준비금: 월 $150 (30%)**
협상 불가입니다. 비즈니스 계좌로 들어오는 모든 dollar의 30%를 별도의 저축 계좌로 이체하십시오. "세금 — 손대지 마시오"라고 표시하십시오.
...
이 레벨에서 재투자 결정은 특정 질문에 의해 주도되어야 합니다: **"다음 $10K로 가는 병목은 무엇인가?"**
