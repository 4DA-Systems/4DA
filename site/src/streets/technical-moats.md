---
title: "Module T: Technical Moats -- STREETS by 4DA"
description: "Identify what makes your combination of skills hard to replicate, and how to signal that to the people who'd pay for it."
...
- A clear map of your T-shaped skill profile and where it creates unique value
- Understanding of the five moat categories and which ones apply to you
- A practical framework for selecting and validating niches
- Knowledge of the 2026-specific moats that are available right now
- A competitive intelligence workflow that doesn't require expensive tools
...
- 500,000 developers who know React well
- 50,000 developers who understand healthcare data standards
- 10,000 developers who can deploy local AI models

Any one of those is a crowded market. But:
- React + healthcare + local AI? That intersection might be 50 people worldwide.
...
You should now have:
- [ ] 1-3 deep skills identified
- [ ] 5-10 adjacent skills listed
- [ ] 3-5 non-technical knowledge areas documented
- [ ] 3+ unique intersection combinations written down
- [ ] A rough sense of which intersections have the fewest competitors
...
- A personal component library built over 6 months (50+ pre-built sections)
- Vercel for instant deployment
- A pre-configured analytics setup they clone for every project
...
2. **Create pre-configured AI workflows.** Write system prompts and agent configurations tuned for your most common tasks.

3. **Automate the boring parts.** If you do something more than 3 times, script it. Deployment, testing, client reporting, invoicing.

4. **Demonstrate speed publicly.** Record a timelapse of building something in 2 hours. Post it. Clients will find you.
...
4. **Time-series advantage.** The data you start collecting today becomes more valuable every day because no one can go back and collect yesterday's data. Start now.
...
- If a site explicitly prohibits scraping, don't scrape it
- Add value through organization and analysis, not just aggregation
- Be transparent about your data sources when selling
...
- 12 data extraction scripts (product data from various platforms)
- 8 content generation pipelines (product descriptions, SEO metadata, social posts)
- 5 reporting automations (weekly analytics summaries for clients)
- 4 deployment scripts (push updates to client stores)
- 3 monitoring bots (alert on price changes, stock issues, broken links)
...
Pricing: $1,500/month retainer per client (10 clients = $15,000/month)
Time per client after automation: 4-5 hours/month (monitoring and adjustments)
Effective hourly rate: $300-375/hr
...
- [ ] The five moat categories: Integration, Speed, Trust, Data, Automation
- [ ] Which categories match your current strengths and situation
- [ ] Specific examples of each moat type with real revenue numbers
- [ ] How moat categories combine for stronger positioning
- [ ] Which moat type you want to prioritize building first
...
- A SaaS product gets better as you add features based on user feedback
- A data pipeline becomes more valuable as the historical dataset grows
- A template library becomes faster with each project
- A reputation grows with each piece of published content
- An automation library covers more edge cases with each client

Examples of NOT compounding:
- Custom one-off development (done when delivered, no reuse)
- Hourly consulting with no content production (time-for-money, doesn't scale)
- A tool that solves a problem that will go away (migration tools for a one-time migration)
...
How to check:
- Google Trends: Is search interest increasing?
- npm/PyPI downloads: Are the relevant packages growing?
- Job postings: Are companies hiring for this technology/domain?
- Conference talks: Is this topic appearing at more conferences?
- GitHub activity: Are new repos in this space getting stars?
...
You should now have:
- [ ] Understanding of the 4-question filter
- [ ] A completed scoring matrix for at least 3 potential niches
- [ ] A clear top candidate based on the scores
- [ ] Knowledge of what makes a niche strong vs. weak
- [ ] Honest assessment of where your candidates fall
...
- Project management: Basecamp, Monday.com (beyond basic)
...
You should now have:
- [ ] Understanding of all seven 2026-specific moats
- [ ] 1-2 moats identified that match your T-shape and situation
- [ ] A concrete action you can take THIS WEEK to start building
- [ ] Realistic expectations about timeline and revenue for your chosen moat
- [ ] Awareness of which moats are time-sensitive (move now) vs. durable (can build over time)
...
**What to look for:**
- Repos with many stars but few recent commits = abandoned opportunity. Users want it but the maintainer moved on.
- Repos with many open issues = unmet needs. Read the issues. They're a roadmap of what people want.
- Repos with few stars but recent commits = someone is trying but hasn't found product-market fit. Study their mistakes.
...
- Compare against related terms
- Filter by region if your market is geographically specific

**What to look for:**
- Rising trend = growing market (good)
- Flat trend = stable market (okay, if competition is low)
- Declining trend = shrinking market (avoid)
- Seasonal spikes = plan your launch timing
...
- Go to [similarweb.com](https://www.similarweb.com)
- Enter a competitor's domain
- Note: monthly visits, average visit duration, bounce rate, top traffic sources
- Free tier gives you enough for initial research
...
- **Knowledge gap analysis** (`knowledge_gaps` tool): Shows where your project's dependencies are trending, and where gaps exist in the ecosystem
- **Signal classification** (`get_actionable_signals` tool): Surfaces trending technologies and demand signals from HN, Reddit, and RSS feeds
- **Topic connections** (`topic_connections` tool): Maps relationships between technologies to find unexpected niche intersections
- **Trend analysis** (`trend_analysis` tool): Statistical patterns in your content feed that reveal emerging opportunities
...
You should now have:
- [ ] GitHub search results for existing solutions in your niche
- [ ] Download/adoption trends for relevant packages
- [ ] Google Trends data for your niche keywords
- [ ] Reddit/HN pain point evidence (bookmarked threads)
- [ ] A completed competitive landscape document for your top niche
- [ ] Identified gaps: what exists but is broken, what's missing entirely
...
- Who you are (T-shape)
- What your walls are (moat categories)
- Where you're fighting (niche)
- Who else is in the arena (competitive landscape)
- What you're building this quarter (action plan)
...
- **Primary Moat:** Integration (connecting Ollama to legal practice management tools like Clio)
- **Secondary Moat:** Trust (monthly blog posts about AI in legal tech)
- **Niche:** "I help mid-size law firms (10-50 attorneys) deploy private AI document analysis. Client data never leaves their servers."
- **Niche Score:** Pain 5, WTP 5, Buildability 3, Compounding 4, Growth 5, Fit 4, Competition 5 = **7,500** (strong)
- **Competitors:** Harvey AI (cloud-only, expensive), CoCounsel ($250/user/mo, cloud), generic freelancers (no legal knowledge)
- **Gap:** No solution combines local AI + legal PMS integration + legal workflow understanding
- **Differentiation:** Privacy / local-first (data never leaves the firm)
- **Revenue:** Fixed-price deployments ($5,000-15,000) + monthly retainers ($1,000-2,000)
- **Pricing rationale:** 40 attorneys x $300/hr x 2 hrs/week saved = $24,000/week in recovered billable time. $10,000 deployment pays for itself in 3 days.
- **First dollar:** "Private AI Document Analysis Pilot" for former employer, $5,000, by March 15
- **90-day plan:**
  - Month 1: Publish blog post, build reference deployment, contact 5 firms, deliver free audits
  - Month 2: Deliver pilot, write case study, contact 10 more firms, get referrals
  - Month 3: Deliver 2-3 more projects, convert 1 to retainer, launch Clio MCP server as product
  - Target: $15,000+ total revenue by day 90
- **Kill criteria:** If no firm agrees to paid pilot within 45 days, pivot to healthcare
- **Moat maintenance:** Monthly blog posts (trust), template library after every project (speed), anonymized benchmarks (data)
...
- "That's interesting, but I wouldn't pay for it." → The pain isn't strong enough. Find a more acute problem.
- "I'd pay for it, but not $[your price]." → Price is wrong. Adjust downward or add more value.
- "Someone else already does this." → You have a competitor you missed. Research them and differentiate.
- "I don't understand what this is." → Your positioning is unclear. Rewrite the description.
- Radio silence (no response) → Your target audience doesn't hang out where you looked. Find them elsewhere.
...
You should now have:
- [ ] A complete Moat Map document saved alongside your Sovereign Stack Document
- [ ] All 7 sections filled in with real data (not aspirational projections)
- [ ] A 90-day execution plan with specific weekly actions
- [ ] Kill criteria defined (when to pivot, when to persist)
- [ ] A validation plan: 3-5 people to contact this week
- [ ] A date set for your first monthly Moat Map review (30 days from now)
...
- **8 specific revenue engine playbooks** — complete with code templates, pricing guides, and launch sequences for each engine type (digital products, SaaS, consulting, content, automation services, API products, templates, and education)
- **Build-along projects** — step-by-step instructions for building real, revenue-generating products in your niche
- **Pricing psychology** — how to price your offerings for maximum revenue without scaring away customers
- **Launch sequences** — the exact steps for going from "built" to "sold" for each revenue engine type
- **Financial modeling** — spreadsheets and calculators for projecting revenue, costs, and profitability
