...
description: "Voce passou treze semanas construindo algo que a maioria dos developers nunca constroi: uma operacao de renda soberana. Voce tem infrastructure. Voce te..."
layout: streets-module.njk
permalink: "/streets/pt-BR/stacking-streams/"
...
prevLabel: "Anterior"
nextLabel: "Próximo"
prevUrl: "/streets/pt-BR/tactical-automation/"
prevTitle: "Modulo T: Automacao Tatica"
alternates:
...
Agora vem a parte que separa o developer que ganha $2K/mes extras daquele que substitui completamente seu salario: **stacking**.
...
> **Erro Comum:** Projetar streams para revenue maximo em vez de interacao maxima. Um stream que gera $800/mes E alimenta dois outros streams tem mais valor do que um stream que gera $2,000/mes isoladamente. O stream isolado adiciona $2,000. O stream conectado adiciona $800 mais aceleracao de crescimento em todo o portfolio. Em 12 meses, o stream conectado ganha sempre.
...
Dez mil dollars por mes e o numero onde tudo muda. Nao e arbitrario.

- **$10K/mes = $120K/ano.** Isso iguala ou supera o salario mediano de software developer nos EUA.
- **$10K/mes apos impostos (~$7K liquidos) cobre uma vida de classe media** na maioria das cidades americanas e uma vida confortavel em quase qualquer outro lugar do mundo.
- **$10K/mes de multiplos streams e mais estavel** do que $15K/mes de um unico empregador, porque nenhuma falha unica pode levar voce de $10K a $0.
- **$10K/mes prova o modelo.** Se voce consegue fazer $10K/mes independentemente, voce consegue fazer $20K/mes. O sistema funciona. Tudo depois disso e otimizacao.

Abaixo de $10K/mes, voce esta suplementando. Em $10K/mes, voce e independente. Por isso importa.
...
### Nivel 1: Primeiros $500/Mes

Voce cruzou o limiar. Voce esta ganhando dinheiro. Nao muito, mas e real. Aqui esta onde vai:

**Reserva de impostos: $150/mes (30%)**
Isso e nao negociavel. Transfira 30% de cada dollar que entrar na sua conta de negocios para uma conta poupanca separada. Rotule como "IMPOSTOS — NAO TOQUE." A Receita Federal (ou sua autoridade fiscal local) vira buscar esse dinheiro. Tenha-o pronto.
...
### Nivel 4: Primeiros $10,000/Mes

Voce tem um negocio real. Trate-o como tal.

**Reserva de impostos: $3,000/mes (30%)**


Neste nivel, suas decisoes de reinvestimento devem ser guiadas por uma pergunta especifica: **"Qual e o gargalo para os proximos $10K?"**
...
- **Constituicao de LLC** se ainda nao feito. A $120K/ano, um LLC nao e opcional.
