---
title: "Modül S: Gelir Akışlarını İstiflemek -- STREETS by 4DA"
description: "On üç hafta boyunca çoğu geliştiricinin asla inşa etmediği bir şey inşa ettin: egemen bir gelir operasyonu. Altyapın var. Gelir motorların çalışıyor. Uy..."
layout: streets-module.njk
permalink: "/streets/tr/stacking-streams/"
...
prevLabel: "Önceki"
nextLabel: "Sonraki"
prevUrl: "/streets/tr/tactical-automation/"
prevTitle: "Modul T: Taktik Otomasyon"
alternates:
...
Şimdi ayda ekstra $2K kazanan geliştiriciyi maaşını tamamen değiştiren geliştiriciden ayıran kısım geliyor: **istifleme**.
...
> **Yaygın Hata:** Maksimum etkileşim yerine maksimum gelir için akış tasarlamak. Ayda $800 üreten VE iki diğer akışı besleyen bir akış, izolasyonda ayda $2,000 üreten bir akıştan daha değerlidir. İzole akış $2,000 ekler. Bağlı akış $800 artı tüm portföyde büyüme ivmesi ekler. 12 ay boyunca bağlı akış her zaman kazanır.
...
Ayda on bin dolar, her şeyin değiştiği rakamdır. Keyfi değildir.

- **$10K/ay = $120K/yıl.** Bu, ABD'deki medyan yazılım geliştiricisi maaşına eşit veya onu aşar.
- **$10K/ay vergi sonrası (~$7K net) çoğu ABD şehrinde orta sınıf bir yaşamı** ve dünyanın neredeyse her yerinde rahat bir yaşamı karşılar.
- **Birden fazla akıştan $10K/ay**, tek bir işverenden $15K/ay'dan daha istikrarlıdır, çünkü tek bir başarısızlık seni $10K'dan $0'a düşüremez.
- **$10K/ay modeli kanıtlar.** Bağımsız olarak $10K/ay kazanabiliyorsan, $20K/ay kazanabilirsin. Sistem çalışıyor. Bundan sonraki her şey optimizasyondur.

$10K/ay'ın altında takviye yapıyorsun. $10K/ay'da bağımsızsın. İşte bu yüzden önemli.
...
**Vergi karşılığı: $150/ay (%30)**
Bu pazarlık götürmez. İş hesabına düşen her doların'ın %30'unu ayrı bir birikim hesabına aktar. "VERGİLER — DOKUNMA" olarak etiketle. Vergi dairesi (IRS, HMRC veya yerel vergi otoriten) bu para için gelecek. Hazır tut.
...
### Seviye 4: İlk $10,000/Ay

Gerçek bir işin var. Ona öyle davran.

**Vergi karşılığı: $3,000/ay (%30)**


Bu seviyede yeniden yatırım kararların belirli bir soru tarafından yönlendirilmeli: **"Sonraki $10K'nın önündeki darboğaz ne?"**
...
**Yapısal yatırımlar:**
- Henüz yapılmadıysa **LLC kuruluşu**. $120K/yılda LLC isteğe bağlı değildir.
