---
title: "Module S : Empiler les Flux de Revenus -- STREETS by 4DA"
description: "Tu as passe treize semaines a construire quelque chose que la plupart des developpeurs ne construisent jamais : une operation de revenus souveraine. Tu..."
layout: streets-module.njk
permalink: "/streets/fr/stacking-streams/"
...
prevLabel: "Précédent"
nextLabel: "Suivant"
prevUrl: "/streets/fr/tactical-automation/"
prevTitle: "Module T : Automatisation Tactique"
alternates:
...
Maintenant vient la partie qui separe le developpeur qui gagne $2K/mois en plus de celui qui remplace entierement son salaire : **l'empilement**.
...
- Fourchette typique : $300-3 000/mois
...
> **Erreur Courante :** Concevoir des flux pour maximiser les revenus au lieu de maximiser l'interaction. Un flux qui genere $800/mois ET alimente deux autres flux a plus de valeur qu'un flux qui genere $2 000/mois isole. Le flux isole ajoute $2 000. Le flux connecte ajoute $800 plus une acceleration de croissance sur l'ensemble du portefeuille. Sur 12 mois, le flux connecte gagne a chaque fois.
...
Dix mille dollars par mois est le chiffre ou tout change. Ce n'est pas arbitraire.

- **$10K/mois = $120K/an.** Ca egale ou depasse le salaire median d'un developpeur logiciel aux Etats-Unis.
- **$10K/mois apres impots (~$7K net) couvre une vie de classe moyenne** dans la plupart des villes americaines et une vie confortable presque partout ailleurs dans le monde.
- **$10K/mois de sources multiples est plus stable** que $15K/mois d'un seul employeur, parce qu'aucun echec individuel ne peut te faire passer de $10K a $0.
- **$10K/mois prouve le modele.** Si tu peux faire $10K/mois de facon independante, tu peux faire $20K/mois. Le systeme fonctionne. Tout apres ca est de l'optimisation.

En dessous de $10K/mois, tu complementes. A $10K/mois, tu es independant. C'est pourquoi ca compte.
...
### Niveau 1 : Premiers $500/Mois

Tu as franchi le seuil. Tu gagnes de l'argent. Ce n'est pas beaucoup, mais c'est reel. Voici ou ca va :

**Reserve d'impots : $150/mois (30%)**
C'est non negociable. Transfere 30% de chaque dollar qui arrive sur ton compte professionnel vers un compte d'epargne separe. Etiquette-le "IMPOTS — NE PAS TOUCHER." Le fisc viendra chercher cet argent. Aie-le pret.
...
### Niveau 4 : Premiers $10 000/Mois

Tu as une vraie entreprise. Traite-la comme telle.

**Reserve d'impots : $3 000/mois (30%)**


A ce niveau, tes decisions de reinvestissement doivent etre guidees par une question specifique : **"Quel est le goulot d'etranglement vers les prochains $10K ?"**
...
- **Creation de LLC** si pas encore fait. A $120K/an, une LLC n'est pas optionnelle.
