...
const { findPIIByHash, PII_EXCLUDE_PATHS } = require('./lib/pii-hashes.cjs');
...
// so this gate and scripts/public-readiness-audit.cjs cannot drift apart.
