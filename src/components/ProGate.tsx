  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="bg-bg-secondary/95 backdrop-blur-sm border border-accent-gold/30 rounded-xl px-6 py-5 text-center max-w-sm shadow-lg">
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <span className="text-sm font-semibold text-accent-gold tracking-wide uppercase">{t('tier.signal')}</span>
          </div>
