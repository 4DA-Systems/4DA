    ...
    <div className="bg-bg-tertiary rounded-lg p-4 border border-border">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="text-xs text-text-muted block mb-1.5">{t('settings.ai.maxItemsBatch')}</label>
            <input
              type="number"
          ...
          <div>
            <label className="text-xs text-text-muted block mb-1.5">{t('settings.ai.minScore')}</label>
            <input
              type="number"
              step="0.05"
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="text-xs text-text-muted block mb-1.5">{t('settings.ai.dailyTokenLimit')}</label>
            <input
              type="number"
          ...
          <div>
            <label className="text-xs text-text-muted block mb-1.5">{t('settings.ai.costLimit')}</label>
            <input
              type="number"
