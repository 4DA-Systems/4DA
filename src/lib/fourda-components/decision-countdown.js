// GAME Component: decision-countdown — auto-generated, do not edit.
(function(){
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    // ── Layer 2: countdown ──
    {
        ...
        var color_result: vec4<f32>;
        {
            ...
            let warp_y = fbm2(p * 5.000000 + vec2<f32>(1.7, 0.0), i32(2.000000), 0.050000, 2.000000);
            p = p + vec2<f32>(warp_x, warp_y) * 0.050000; }
            var sdf_result = abs(length(p) - 0.340000) - 0.050000;
...
`;
const UNIFORMS = [{name:'progress',default:1},{name:'urgency',default:0}];
...
class GameResonanceNetwork {
  constructor() {
    this._couplings = [
      { source: 'urgency', target: 'countdown', field: 'brightness', weight: 0.4 },
    ];
    this._damping = 0.95;
    this._maxDepth = 4;
    this._state = new Map();
...
class DecisionCountdown extends HTMLElement {
  constructor() {
    super();
